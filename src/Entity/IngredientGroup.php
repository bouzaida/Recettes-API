...
class IngredientGroup
{
     ...
     */
    #[ORM\OneToMany(targetEntity: RecipeHasIngredient::class, mappedBy: 'ingredientGroupe')]
    ...
    public function addRecipeHasIngredient(RecipeHasIngredient $recipeHasIngredient): static
    {
        if (!$this->recipeHasIngredients->contains($recipeHasIngredient)) {
            ...
            $recipeHasIngredient->setIngredientGroupe($this);
        }
    ...
    public function removeRecipeHasIngredient(RecipeHasIngredient $recipeHasIngredient): static
    {
        if ($this->recipeHasIngredients->removeElement($recipeHasIngredient)) {
            ...
            if ($recipeHasIngredient->getIngredientGroupe() === $this) {
                $recipeHasIngredient->setIngredientGroupe(null);
            }
        }
